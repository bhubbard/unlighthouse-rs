  ...
  'performance': [
    {
      cols: 1,
      label: 'FCP',
      tooltip: 'First Contentful Paint marks the time at which the first text or image is painted. [FCP metric documentation](https://developer.chrome.com/docs/lighthouse/performance/first-contentful-paint/).',
    ...
    },
    {
      cols: 2,
      label: 'LCP',
      tooltip: 'Largest Contentful Paint marks the time at which the largest text or image is painted. [LCP metric documentation](https://web.dev/lighthouse-largest-contentful-paint/)',
    ...
    },
    {
      ...
      label: 'FID',
      warning: true,
      tooltip: 'Warning: This is deprecated in favour if INP which is not yet supported by Unlighthouse. The maximum potential First Input Delay that your users could experience is the duration of the longest task. [FID metric documentation](https://web.dev/lighthouse-max-potential-fid/).',
      sortKey: 'numericValue',
    ...
    },
    {
      cols: 1,
      label: 'TBT',
      tooltip: 'Sum of all time periods between FCP and Time to Interactive, when task length exceeded 50ms, expressed in milliseconds. [TBT metric documentation](https://web.dev/lighthouse-total-blocking-time/).',
      sortKey: 'numericValue',
    ...
    },
    {
      ...
      label: 'SI',
      sortKey: 'numericValue',
      tooltip: 'The speed index is a page load performance metric that shows you how quickly the contents of a page are visibly populated. [Speed Index documentation](https://web.dev/speed-index/).',
